...
<!-- build-info --> _v1.0.0.6 · Build 20260328.1844_
...
### What Claude Can Do
- 💬 **Chat** — talk through the RetroCode chat panel
- ✏️ **Write code** — directly in your editor with syntax highlighting
- 💾 **Save files** — to disk from the editor
- ▶️ **Run scripts** — in the embedded terminal
- 📖 **Read your code** — understand and modify what you've written
- 🔀 **Switch modes** — Assembly, BASIC, or Code editor
- 📑 **Manage tabs** — open, switch, create new files
...
### Code Mode
A full-featured code editor with syntax highlighting for **25 programming languages**.
...
- **25 programming languages** with syntax highlighting
...
- **21 MCP tools** for Claude AI integration
...
| Code Editor (25 languages) | [Wiki: Code Editor](https://github.com/senzalldev/retrocode-app/wiki/Code-Editor) |
